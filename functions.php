				...
				<div id="aim-content" class="bottom-section">
					<form method="POST">
						...
						<div class="buttons flex space-between">
							<div class="flex">
								<div class="modal-trigger" data-type="info" data-content="<p>You know the drill:</p><ol><li>Get Older</li><li>Solve Puzzles</li><li>Have Fun</li></ol><p style='font-style:italic;'>You will need to remember all the crazy adventures for this one. Good luck.</p>" data-title="Help">
